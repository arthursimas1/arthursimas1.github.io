...
It worked. I had changed the locks on the doors, and now I held the only key I needed. The ADM2 slot was permanently locked out, but it didn't matter anymore because I had bypassed it completely.

Even though I had successfully sidestepped the password by altering the file permissions, it still bothered me to know that the card's internal retry counter for ADM2 was maxed out.
...
Now, it was time to test the unlock.
...
That was the last puzzle piece. Not only had I bypassed the ADM2 lock earlier, but I had now completely revived the card from its bricked state. Since I now knew *all* the passwords for this SIM, I happily reverted the EF.ARR records back to their original factory shape.
