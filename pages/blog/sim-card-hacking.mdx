...
```shell /"ef_arr_file_id": "6f06"/ /"ef_arr_record_nr": 16/ /"control_reference_template": "ADM2"/
...
```shell /"ef_arr_file_id": "6f06"/ /"ef_arr_record_nr": 3/
...
```shell /"control_reference_template": "ADM1"/
